        ...
        <div className="w-1/2 pr-0">
          <div className="flex relative float-right">
            ...
            <div className="relative text-sm">
              ...
              <div onClick={() => logout()} id="userMenu" className={`bg-white hover:bg-gray-400 rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 ${!showUserMenu && "invisible"}`}>
        ...
        <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
          <ul className="list-reset lg:flex flex-1 items-center px-4 md:px-0">
            <li className="mr-6 my-2 md:my-0">
              <Link to="/dashboard" className="flex py-1 md:py-3 pl-1 align-middle text-pink-600 no-underline hover:text-gray-900 border-b-2 border-orange-600 hover:border-orange-600">
            ...
            <li className="mr-6 my-2 md:my-0">
              <Link to="/" className="flex py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
